 ...
 * @internal
 */
class Migration1763373865 extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement("
            CREATE TABLE IF NOT EXISTS `purchase_price_history`(
                ...
                PRIMARY KEY (`id`),
                KEY `fk.purchase_price_history.product_id` (`product_id`),
                CONSTRAINT `fk.purchase_price_history.product_id` FOREIGN KEY (`product_id`)
